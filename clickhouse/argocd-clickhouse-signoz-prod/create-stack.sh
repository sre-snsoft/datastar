...
argocd app create clickhouse-operator \
 ...
 --path clickhouse/argocd-clickhouse-posthog/apps/clickhouse-operator \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}

argocd app create prometheus \
 --repo https://github.com/ranmaoshu1/datastar.git \
 --path clickhouse/argocd-clickhouse-posthog/apps/prometheus \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}

argocd app create grafana \
 --repo https://github.com/ranmaoshu1/datastar.git \
 --path clickhouse/argocd-clickhouse-posthog/apps/grafana \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}

argocd app create zookeeper \
 --repo https://github.com/ranmaoshu1/datastar.git \
 --path clickhouse/argocd-clickhouse-posthog/apps/zookeeper \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}

argocd app create clickhouse \
 --repo https://github.com/ranmaoshu1/datastar.git \
 --path clickhouse/argocd-clickhouse-posthog/apps/clickhouse \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}

argocd app create cloudbeaver \
 --repo https://github.com/ranmaoshu1/datastar.git \
 --path clickhouse/argocd-clickhouse-posthog/apps/cloudbeaver \
 --dest-server https://kubernetes.default.svc --dest-namespace ${NS}
